...
use App\Services\Interfaces\ApprenantsFirebaseServiceInterface;
...
class ApprenantsFirebaseService implements ApprenantsFirebaseServiceInterface
{
    ...
    public function createApprenant(array $data)
    {
        ...
        SendAuthEmailJob::dispatch("damewade20@gmail.com", $defaultPassword, $userData['nom'], $userData['prenom'], $this->qrCodeService, $this->pdfService);
